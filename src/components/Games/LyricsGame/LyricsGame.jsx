    ...
    <div className="relative w-full h-full flex flex-col items-center justify-center overflow-hidden bg-transparent pt-16 pb-8 px-8">
      ...
      <div className="flex w-full max-w-[80vw] h-[82vh] bg-[#FDFBF7] flex-col rounded-3xl shadow-xl border border-gray-300 overflow-hidden relative z-30 mt-6">
        ...
        <div className="flex-1 w-full bg-[#FCFBF4] overflow-hidden relative flex flex-col items-center py-0 px-8 border-b border-gray-300">
          ...
          {/* 將音符裝飾往兩側推，避免擋到中間的歌詞 (left/right 值變小或變大) */}
          <img src="/images/note_1.png" alt="note" className="absolute top-12 left-8 w-10 h-10 opacity-30 -rotate-12 pointer-events-none z-10" />
          <img src="/images/note_2.png" alt="note" className="absolute bottom-20 right-8 w-12 h-12 opacity-20 rotate-12 pointer-events-none z-10" />
          <img src="/images/note_3.png" alt="note" className="absolute top-1/3 right-10 w-10 h-10 opacity-25 rotate-45 pointer-events-none z-10" />
          <img src="/images/note_1.png" alt="note" className="absolute bottom-1/3 left-6 w-8 h-8 opacity-20 -rotate-6 pointer-events-none z-10" />
